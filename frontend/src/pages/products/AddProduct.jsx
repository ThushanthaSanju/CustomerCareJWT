...
const useStyles = makeStyles((theme) => ({
  ...
  image: {
    backgroundImage:
      "url(https://wallpapercave.com/wp/wp5623815.jpg)",
...
const AddProduct = (props) => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    setOpen(true);
    try {
      const { productID, productName, price, description, warantyPeriod } = state;
      if (validateForm(state.errors)) {
        ...
        if (
          ...
          if (image) {
            ...
            setErrorMsg("");
            await axios.post(`${API_URL}/pCtrl/insert`, formData, {
            });
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate onSubmit={handleOnSubmit}>
            ...
            <TextField
              ...
              name="warantyPeriod"
              autoComplete="warantyPeriod"
              autoFocus
              value={state.warantyPeriod || ""}
              onChange={handleChange}
            />
